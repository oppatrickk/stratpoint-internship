...
extension FirestoreX on FirebaseFirestore {
  Future<DocumentReference<Object?>> userDocument() async {
...
extension DocumentReferenceX on DocumentReference<Object?> {
  CollectionReference<Object?> get noteCollection => collection('notes');
}
